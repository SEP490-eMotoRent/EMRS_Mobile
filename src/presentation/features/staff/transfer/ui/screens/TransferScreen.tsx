          ...
          <View style={styles.handoverHeader}>
            <View style={styles.timeSection}>
              <AntDesign
                ...
                color={colors.text.primary}
              />
              <Text style={styles.timeText}>2:00 PM - 2:30 PM</Text>
              <Text style={styles.timeSubtext}>In 4 hours</Text>
            </View>
            <TouchableOpacity style={styles.arrivalButton}>
              <Text style={styles.arrivalButtonText}>Arrives in 1 hour</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.authContent}>
            ...
            <View style={styles.authRight}>
              <TouchableOpacity style={styles.scanButton}>
                <AntDesign name="camera" size={16} color="#FFFFFF" />
                <Text style={styles.scanButtonText}>Scan Return Face</Text>
              </TouchableOpacity>
            </View>
          </View>
          <Text style={styles.authTitle}>Xác thực khách hàng trả xe</Text>
          <Text style={styles.authDescription}>
            Sử dụng camera để xác thực khuôn mặt khách hàng để tìm kiếm thông
            tin trả xe của họ
          </Text>
        </InfoCard>
      </View>

      {/* Today's Vehicle Return Schedule */}
      <View style={styles.scheduleSection}>
        <View style={styles.scheduleHeader}>
        ...
        <View style={styles.handoverCard}>
          <View style={styles.handoverHeader}>
            <View style={styles.timeSection}>
              <AntDesign
                ...
                color={colors.text.primary}
              />
              <Text style={styles.timeText}>9:00 AM - 9:30 AM</Text>
              <Text style={styles.timeSubtext}>In 30 min</Text>
            </View>
            <TouchableOpacity
              style={[styles.arrivalButton, { backgroundColor: "#67D16C" }]}
            >
              <Text style={styles.arrivalButtonText}>Ready to return</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.customerSection}>
            <View style={styles.customerInfo}>
              <AntDesign name="user" size={16} color={colors.text.primary} />
              <Text style={styles.customerName}>Alice Smith</Text>
              <AntDesign name="check-circle" size={16} color="#4CAF50" />
              <Text style={styles.bookingId}>#EMR240914001</Text>
            </View>
          </View>
          ...
          <View style={styles.vehicleSection}>
            ...
            <View style={styles.vehicleInfo}>
              <Text style={styles.vehicleName}>VinFast Evo200</Text>
              <Text style={styles.rentalDuration}>5 days rental</Text>
            </View>
          </View>
          ...
          <View style={styles.specsSection}>
            <Text style={styles.specsTitle}>Return Information</Text>
            <Text style={styles.branchText}>District 2 Branch</Text>
            ...
            <View style={styles.specsGrid}>
              <View style={styles.specCard}>
                <AntDesign
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Current Odometer: 1,250 km</Text>
              </View>
              <View style={styles.specCard}>
                <FontAwesome
                  name="battery-4"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Battery Level: 85%</Text>
              </View>
              <View style={styles.specCard}>
                <AntDesign
                  name="clock-circle"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Return Time: 9:00 AM</Text>
              </View>
              <View style={styles.specCard}>
                <FontAwesome5
                  name="weight-hanging"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Condition: Good</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.handoverCard}>
          <View style={styles.handoverHeader}>
            <View style={styles.timeSection}>
              <AntDesign
                ...
                color={colors.text.primary}
              />
              <Text style={styles.timeText}>3:00 PM - 3:30 PM</Text>
              <Text style={styles.timeSubtext}>In 5 hours</Text>
            </View>
            <TouchableOpacity
              style={[styles.arrivalButton, { backgroundColor: "#FFB300" }]}
            >
              <Text style={styles.arrivalButtonText}>Scheduled return</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.customerSection}>
            <View style={styles.customerInfo}>
              <AntDesign name="user" size={16} color={colors.text.primary} />
              <Text style={styles.customerName}>Bob Johnson</Text>
              <AntDesign name="check-circle" size={16} color="#4CAF50" />
              <Text style={styles.bookingId}>#EMR240914002</Text>
            </View>
          </View>
          ...
          <View style={styles.vehicleSection}>
            ...
            <View style={styles.vehicleInfo}>
              <Text style={styles.vehicleName}>Klara S</Text>
              <Text style={styles.rentalDuration}>2 days rental</Text>
            </View>
          </View>
            ...
            <View style={styles.specsGrid}>
              <View style={styles.specCard}>
                <AntDesign
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Current Odometer: 980 km</Text>
              </View>
              <View style={styles.specCard}>
                <FontAwesome
                  name="battery-4"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Battery Level: 92%</Text>
              </View>
              <View style={styles.specCard}>
                <AntDesign
                  name="clock-circle"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Return Time: 3:00 PM</Text>
              </View>
              <View style={styles.specCard}>
                <FontAwesome5
                  name="weight-hanging"
                  ...
                  color={colors.text.primary}
                />
                <Text style={styles.specText}>Condition: Excellent</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.tabContainer}>
          ...
          >
            <AntDesign
              ...
              size={16}
              color={
                activeTab === "handover" ? "#C9B6FF" : colors.text.secondary
              }
            />
            <Text
              style={[
          ...
          >
            <AntDesign
              name="undo"
              size={16}
              color={activeTab === "return" ? "#C9B6FF" : colors.text.secondary}
            />
            <Text
              style={[
                styles.tabText,
